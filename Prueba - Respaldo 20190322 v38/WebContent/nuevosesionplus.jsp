...
<div id="home" class="container spacer about">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
				...
				<div class="form-group col-md-12 col-sm-12 col-xs-12">
					<label class="col-md-6 col-sm-6 col-xs-6 control-label" for="">Descripción</label>
					<label class="col-md-6 col-sm-6 col-xs-6 control-label" for=""><%=camp.getDescripcion()%></label>
				</div><br>
	...
	<form class="form-horizontal "
		...
		<fieldset>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			  	<% if(sa!=null && (sa.isAsistio())){ %>
			  		<input id="35_Asistio" name="35_Asistio" type="checkbox" checked> Sí / No
			  	<% }else{ %>
			  		<input id="35_Asistio" name="35_Asistio" type="checkbox"> Sí / No
			  	<% } %>
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			  	<% if(sa!=null && (sa.isFotos_Seleccionadas())){ %>
			  		<input id="35_Entregadas" name="35_Entregadas" checked type="checkbox"> Sí / No
			  	<% }else{ %>
				  	<input id="35_Entregadas" name="35_Entregadas" type="checkbox"> Sí / No
				<% } %>
			  </div>
			</div>
