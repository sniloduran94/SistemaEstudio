...
public class WriteExcelDescuento{
...
public void setOutputFile(String inputFile) {
  ...
  public void write(ArrayList<ArrayList<String>> arreglo) throws IOException, WriteException {
    ...
    workbook.createSheet("Descuentos", 0);
  ...
  private void createLabel(WritableSheet sheet)
    ...
    addCaption(sheet, 1, 1, "Ticket");
    addCaption(sheet, 2, 1, "Nombre cliente");
    addCaption(sheet, 3, 1, "Descuento");
  }
