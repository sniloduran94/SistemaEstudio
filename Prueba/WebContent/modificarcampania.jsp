...
<h2 class="text-center wowload fadeInUp">Modificar Campaña</h2> 
	<form name="formcliente" class="form-horizontal wowload fadeInUp" action="ServletCampania?opcion=ModificarCampania" method="post">
	<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="text" value="<%=camp.getNombre()%>" name="17_Nombre" maxlength="30" id="17_Nombre" required/>
  </div>
</div>
	...
	<select class="form-control"  name="14_Id_Canal_Venta" id="14_Id_Canal_Venta" required="">
		...
		<%
				...
				while(it.hasNext())
				{
					...
					if(c.getId_Canal_Venta()==camp.getId_Canal_Venta()){
		%>
				<option value="<%=c.getId_Canal_Venta()%>" selected><%=c.getCanal()%></option>
		<% 			} else{ %>
...
<%	
	...
	String fecha = sdf.format(camp.getInicio_Vigencia());
	String fecha2 = sdf.format(camp.getFin_Vigencia());
 %>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="17_Precio">Precio (CLP) <i class="fa fa-money fa-1x"></i></label>
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=Integer.toString(camp.getPrecio())%>" name="17_Precio" maxlength="11" id="17_Precio"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getMaximo_Personas()%>" name="17_Maximo_Personas" maxlength="30" min="0" id="17_Maximo_Personas"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  	<textarea name="17_Descripcion" id="17_Descripcion"><%=camp.getDescripcion()%></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  	<textarea name="17_Descripcion_Adicional" id="17_Descripcion_Adicional"><%=camp.getDescripcion_Adicional()%></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
			  <% if(camp.isCD()) {	%>
			  		<input id="reclamo" name="17_Posee_CD" type="checkbox" checked onClick="mostrarOcultar(this)"> 
			  <% }else{					%>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<% if(camp.isCD()) {	%>
		<input class="form-control" value="<%=camp.getCant_Fotos_CD()%>" placeholder="Cantidad de fotos"  maxlength="8" style="visibility:visible;" min="0" id="17_Cant_Fotos_CD" name="17_Cant_Fotos_CD" type="number">  		
	<% }else{					%>
		<input class="form-control" value="<%=camp.getCant_Fotos_CD()%>" placeholder="Cantidad de fotos"  maxlength="8" style="visibility:hidden;" min="0" id="17_Cant_Fotos_CD" name="17_Cant_Fotos_CD" type="number">
	 <% } 					%>	
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getCant_10x15()%>" name="17_Cant_10x15" maxlength="30" min="0" id="17_Cant_10x15"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getCant_15x21() %>" name="17_Cant_15x21" maxlength="30" min="0" id="17_Cant_15x21"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getCant_20x30() %>" name="17_Cant_20x30" maxlength="30" min="0" id="17_Cant_20x30"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getCant_30x40() %>" name="17_Cant_30x40" maxlength="30" min="0" id="17_Cant_30x40"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getPrecio_Adicional() %>" name="17_Precio_Adicional" maxlength="11" id="17_Precio_Adicional"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getPrecio_Reagendamiento() %>" name="17_Precio_Reagendamiento" maxlength="11" id="17_Precio_Reagendamiento"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="number" value="<%=camp.getAbono()%>" name="17_Abono" maxlength="11" id="17_Abono" placeholder="10990"/>
  </div>
</div>
