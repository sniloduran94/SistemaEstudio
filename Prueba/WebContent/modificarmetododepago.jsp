...
<!-- Fin Calendario -->
	...
	<% 
		...
		//Obtencion del metodo de pago a modificar
		Metodo_Pago mp = (Metodo_Pago) request.getAttribute("metodo_pago");
...
<input class="form-control" type="hidden" value="<%=mp.getId_Metodo_Pago()%>" name="37_Id_Metodo_Pago" id="37_Id_Metodo_Pago" required />
	
<div class="form-group">	
	<label class="col-md-4 control-label" for="37_Nombre">Alias del método de pago</label>
	<div class="col-md-4">
		<input class="form-control" type="text" value="<%=mp.getNombre()%>" name="37_Nombre" id="37_Nombre" required />
	</div>
</div>

<div class="form-group">
  <label class="col-md-4 control-label" for="37_Descripcion">Descripción</label>
  <div class="col-md-8">
    <textarea name="37_Descripcion" id="37_Descripcion"><%=mp.getDescripcion()%></textarea>
  </div>
</div>
