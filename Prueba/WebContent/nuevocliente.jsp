...
<h2 class="text-center wowload fadeInUp">Nuevo cliente</h2> 
	<form name="formcliente" class="form-horizontal wowload fadeInUp" action="ServletCliente?opcion=NuevoCliente" method="post">
	<fieldset>
