...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="text" value="" name="04_Mail" maxlength="40" id="04_Mail" placeholder="maildeejemplo@ejemplo.com" required/>
  </div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<input class="form-control" type="number" onChange="prueba_rut()" name="04_Rut_Trabajador" id="04_Rut_Trabajador" placeholder="123456780"/>
	</div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="text" value="" name="04_Apellido_Pat" maxlength="15" id="04_Apellido_Pat" placeholder="" required/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="text" value="" name="04_Apellido_Mat" maxlength="15" id="04_Apellido_Mat" placeholder=""/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="password" value="" name="04_Contrasenia" maxlength="30" id="04_Contrasenia" placeholder=""/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="password" value="" name="R04_Contrasenia" maxlength="30" id="R04_Contrasenia" placeholder="" onChange="comprobarClave()"/>
  </div>
</div>
