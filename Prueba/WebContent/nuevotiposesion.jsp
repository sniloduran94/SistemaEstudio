...
<!-- Fin Calendario -->
	...
	<% 
		...
		ArrayList<Canal_Venta> canalesventas = (ArrayList<Canal_Venta>)(request.getAttribute("tipossesiones"));
...
<h2 class="text-center wowload fadeInUp">Nuevo tipo de sesión</h2> 
	<form name="formcliente" class="form-horizontal wowload fadeInUp" action="ServletTipoSesion?opcion=NuevoTipoSesion" method="post">
	<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  	<input class="form-control" type="text" value="" name="34_Tipo_Sesion" maxlength="30" id="34_Tipo_Sesion" placeholder="" required/>
  </div>
</div>
