...
<!-- Fin Calendario -->
	...
	<% 
		...
		Tipo_Sesion ts = (Tipo_Sesion)request.getAttribute("tiposesion");
...
<div class="form-group">
	<label class="col-md-4 control-label" for="nombredeltipodesesion">Nombre del tipo de sesión</label>
	<div class="col-md-4">
		<input class="form-control" type="text" name="34_Tipo_Sesion" maxlength="15" id="34_Tipo_Sesion" value="<%=ts.getTipo_Sesion()%>" placeholder="Ejemplo: Embarazada" required/>
	</div>
</div>
