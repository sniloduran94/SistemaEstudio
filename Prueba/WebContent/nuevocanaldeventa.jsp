...
<h2 class="text-center">Nuevo canal de venta</h2> 
	<form name="formcliente" class="form-horizontal" action="ServletCanalDeVenta?opcion=NuevoCanalDeVenta" method="post">
	<fieldset>
