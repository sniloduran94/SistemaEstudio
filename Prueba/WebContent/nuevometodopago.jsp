...
<h2 class="text-center wowload fadeInUp">Nuevo método de pago</h2> 
	<form name="formcliente" class="form-horizontal wowload fadeInUp" action="ServletMetodoPago?opcion=NuevoMetodoPago" method="post">
	<fieldset>
...
<div class="form-group">	
	...
	<div class="col-md-4">
		<input class="form-control" type="text" value="" name="37_Nombre" id="37_Nombre" required />
	</div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <textarea name="37_Descripcion" id="37_Descripcion"></textarea>
  </div>
</div>
