...
public class JavaMail {  
	...
	public ArrayList<String> CorreosHoy = new ArrayList<String>(
		    Arrays.asList("central@genesisestudio.cl", "fotografia_2@fotoexpressiones.com", "marcela.pizarro@advancing.cl", "patricio.zarate@advancing.cl"));
	 
	/*public ArrayList<String> CorreosHoy = new ArrayList<String>(
		    Arrays.asList("salodnd@gmail.com", "salomon.nilo@advancing.cl", "salodnd@gmail.com", "salodnd@gmail.com"));
	*/ 
 ...
 public void mandarCorreo(String Correo1, String Correo2, String Correo3, String Mensaje, String Asunto, String correoEnvia, String NombreCorreoEnvia, String correoClave, boolean esParaHoy){  
	  ...
	  try {  
	   ...
	   if(esParaHoy){   
		   this.mandarCorreo(Correo1, Correo2, Correo3, Mensaje, "Nuevo agendamiento para hoy", correoEnvia, NombreCorreoEnvia, correoClave, false);
	   } 
	   transport.close();   
