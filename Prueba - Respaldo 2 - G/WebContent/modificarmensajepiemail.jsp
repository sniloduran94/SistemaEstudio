...
<h2 class="text-center">Modificar mensaje de pie de mails</h2> 
	<form name="formcliente" class="form-horizontal" action="ServletLogin?opcion=CambiarMensajePieMail" method="post">
	<fieldset>
