...
public class WriteExcelCampania {
...
public void setOutputFile(String inputFile) {
  ...
  private void createLabel(WritableSheet sheet)
    ...
    addCaption(sheet, 0, 1, "Id Campaña");
    addCaption(sheet, 1, 1, "Nombre de Campaña");
    addCaption(sheet, 2, 1, "Nombre Canal de venta");
    addCaption(sheet, 3, 1, "Inicio Vigencia");
    addCaption(sheet, 4, 1, "Fin Vigencia");
    addCaption(sheet, 5, 1, "Precio");
    addCaption(sheet, 6, 1, "Maximo Personas");
    addCaption(sheet, 7, 1, "Descripcion");
    addCaption(sheet, 8, 1, "Estado");
    addCaption(sheet, 9, 1, "¿Posee CD?");
    addCaption(sheet, 10, 1, "Cantidad de fotos CD");
    addCaption(sheet, 11, 1, "10x15");
    addCaption(sheet, 12, 1, "15x21");
    addCaption(sheet, 13, 1, "20x30");
    addCaption(sheet, 14, 1, "30x40");
  }
